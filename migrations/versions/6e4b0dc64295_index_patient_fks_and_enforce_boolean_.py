...
BOOLEAN_NOT_NULL = {
    'ai_recommendations': ['is_applied'],
    'allergies': ['verified'],
    'diagnoses': ['is_primary'],
    'lab_results': ['is_abnormal', 'is_critical'],
    'lab_test_catalog': ['is_active'],
    'login_attempts': ['successful'],
    'medications': ['is_active'],
    'messages': ['is_read'],
    'notifications': ['is_read'],
    'order_sets': ['is_published', 'is_active'],
    'clinician_templates': ['is_active'],
    'service_catalog': ['is_active'],
    'therapy_sessions': ['followup_required'],
}


def _backfill_booleans():
    """PostgreSQL refuses SET NOT NULL while NULLs exist; SQLite's table
    rebuild would carry them along. Backfill every boolean that is about to
    become NOT NULL (default False, or True for is_active/is_published)."""
    bind = op.get_bind()
    inspector = sa.inspect(bind)
    existing_tables = set(inspector.get_table_names())
    for table, columns in BOOLEAN_NOT_NULL.items():
        ...
        for col in columns:
            if col not in present:
                continue
            default = 'true' if col in ('is_active',) else 'false'
